# This program adjust the UNet model to also perform Data Augmentation and have with that a better model

# This program has as objective perform Data Augmentation as part of our efforts to enhance the quality of the UNet and MLP models to predict the diopter
# The first part of this program focuses on augmenting the images that feed the UNet
...
if __name__ == "__main__":
    ...
    for img_num, (image_file, mask_file) in enumerate(zip(images_files, masks_files)):
        if preserved_img[img_num]:
            ...
            for rotation_idx in range(num_rotations):
                # Randomly select a rotation angle between 0 and 360 degrees
                ...
                # Append rotated image and mask to lists
    ...
    model.save("UNet_segmen_size_128_DA_10_epoche_50_ordnung.keras") # This line should not be run
